...
import trendTooltip from './time-trend-tooltip.hbs';

class TimeTrendChartView extends BaseChartView {
    PAD_BOTTOM = 50;
    ...
    doShow(data) {
        ...
        const maxY = max(data, d => d.duration);
...
export default TimeTrendChartView;